...
Next.js and Go realtime WebSocket application starter.
...
```bash
npx @boyeep/nextjs-go-realtime-kit my-realtime-app --no-install
```

See the [template repository](https://github.com/Boyeep/nextjs-go-realtime-kit) for setup, architecture, and development documentation.
