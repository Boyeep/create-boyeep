...
API, queue, worker, scheduler, retry, and monitoring starter.
...
```bash
npx @boyeep/python-background-worker-kit my-worker-app --no-install
```

See the [template repository](https://github.com/Boyeep/python-background-worker-kit) for setup, architecture, and development documentation.
