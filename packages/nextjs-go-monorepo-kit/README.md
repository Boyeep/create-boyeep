...
Next.js and Go full-stack monorepo starter.
...
```bash
npx @boyeep/nextjs-go-monorepo-kit my-go-app --no-install
```

See the [template repository](https://github.com/Boyeep/nextjs-go-monorepo-kit) for setup, architecture, and development documentation.
