...
AI agent starter with tools, structured output, streaming, history, and jobs.
...
```bash
npx @boyeep/nextjs-python-ai-agent-kit my-agent --no-install
```

See the [template repository](https://github.com/Boyeep/nextjs-python-ai-agent-kit) for setup, architecture, and development documentation.
