# Next.js + Python Computer Vision Kit
...
Full-stack image and live-camera computer vision starter.
...
```bash
npx @boyeep/nextjs-python-computer-vision-kit my-vision-app --no-install
```

See the [template repository](https://github.com/Boyeep/nextjs-python-computer-vision-kit) for setup, architecture, and development documentation.
